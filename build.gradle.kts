// colecteur-betonquest produces VaniaMetrics-<Name>-<v>.jar in build/libs/.
//
...
// module list refers to modules by their plugin name. One source of truth,
// the one Bukkit displays.
